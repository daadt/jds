...
public class ThreadPoolManager {
    ...
    private ThreadPoolManager() {
        ...
        executor = new ThreadPoolExecutor(
                corePoolSize, //当某个核心任务执行完毕，会依次从缓冲队列中取出等待任务:3
                maximumPoolSize, //最大线程数量,5,先corePoolSize,然后new LinkedBlockingQueue<Runnable>(),然后maximumPoolSize,但是它的数量是包含了corePoolSize的
